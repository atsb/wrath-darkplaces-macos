...
ifeq ($(DP_MAKE_TARGET), mingw)
	...
	# for some reason I can't get the default include folder to include this
	CFLAGS_EXTRA=-I/mingw64/include -L/mingw64/lib
endif
...
DO_LD=$(CC) -arch $(ARCH) -mmacosx-version-min=10.9 -o ../../../$@ $^ $(LDFLAGS)
